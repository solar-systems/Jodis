...
public interface ProtocolConstant {
    ...
    /**
     * todo complete all need log cmd
     */
    Set<String> NEED_LOGS = Sets.newHashSet(KEY_DEL, STRING_SET, STRING_GETSET, STRING_MSET, STRING_SETEX,
            STRING_SETNX, STRING_SETRANGE, STRING_INCR, STRING_INCRBY, STRING_INCRBYFLOAT, STRING_DECR,
            STRING_DECRBY, STRING_APPEND, HASH_HDEL, HASH_HINCRBY, HASH_HINCRBYFLOAT);
}
