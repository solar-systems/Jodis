...
public interface ProtocolConstant {
    ...
    Set<String> STRING_CMDS = Sets.newHashSet(STRING_SET, STRING_GET, STRING_GETRANGE,
            STRING_GETSET, STRING_MGET, STRING_SETEX, STRING_SETNX, STRING_SETRANGE,
    ...
    Set<String> HASH_CMDS = Sets.newHashSet(HASH_HDEL, HASH_HEXISTS, HASH_HGET, HASH_HGETALL,
            ...
            HASH_HSET, HASH_HSETNX, HASH_HVALS, HASH_HSCAN);
    ...
    Set<String> LIST_CMDS = Sets.newHashSet(LIST_LINDEX, LIST_LINSERT, LIST_LPOP, LIST_LPUSH,
            LIST_LPUSHX, LIST_LRANGE, LIST_LREM, LIST_LSET, LIST_LTRIM, LIST_RPOP, LIST_RPOPLPUSH,
            LIST_RPUSH, LIST_RPUSHX);
    ...
    Set<String> SET_CMDS = Sets.newHashSet(SET_SADD, SET_SCARD, SET_SDIFF, SET_SDIFFSTORE, SET_SINTER,
            SET_SINTERSTORE, SET_SISMEMBER, SET_SMEMBERS, SET_SMOVE, SET_SPOP, SET_SRANDMEMBER, SET_SREM,
            SET_SUNION, SET_SUNIONSTORE, SET_SSCAN);
    ...
    Set<String> ZSET_CMDS = Sets.newHashSet(ZSET_ZADD, ZSET_ZCARD, ZSET_ZCOUNT, ZSET_ZINCRBY, ZSET_ZINTERSTORE,
            ...
            ZSET_ZREVRANK, ZSET_ZSCORE, ZSET_ZUNIONSTORE, ZSET_ZSCAN);
}
